const URLs = {
  ...
  trademarkRegistration:
    '/services/intellectual-property/trademark-registration-online',
  trademarkObjection:
    '/services/intellectual-property/trademark-objection-reply',
  trademarkHearing: '/services/intellectual-property/trademark-hearing-chennai',
  trademarkRenewal: '/services/intellectual-property/trademark-renewal',
