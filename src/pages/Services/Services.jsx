...
const Services = () => {
  ...
  const serviceDetails = serviceList.filter(service => service.service === selectedService)[0]

  return <div>
    <ServiceHeroBanner title={serviceDetails.title} desc={serviceDetails.description} price={serviceDetails.price} />
