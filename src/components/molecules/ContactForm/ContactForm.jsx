...
const ContactForm = () => {
  ...
  return (<div className='container px-0 contform-cont'>
    <div className='row h-100 w-100'>
      ...
      <div className="col form-cont">
        <div className='header mt-4' data-aos="fade-up" >
          <h2>Get in <span>touch with us</span> for
            more information</h2>
        </div>
        <div className='container form px-0'>
          <form>
            <div className="row">
              <div className="col-sm-6" data-aos="fade-up" data-aos-delay="50">
            ...
            <div className="row">
              ...
              <div className={`col-sm-6 select ${(selectActive ? " active" : "")}`} data-aos="fade-up" data-aos-delay="200">
                <button type="button" className="ng-binding" onClick={() => { setSelectActive(true) }}>{selectedService}</button>
                <ul className="md-whiteframe-z1" name="ul-id">
                  {services.map((service) =>
                    <li role="option" key={service} onClick={() => { changeService(service) }} className={`${(selectedService === service ? " active" : "")}`} tabIndex="-1">{service}</li>
                  )}
                </ul>
              </div>
            </div>
