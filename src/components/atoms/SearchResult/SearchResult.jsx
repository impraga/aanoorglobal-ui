...
const SearchResult = ({ data }) => (
  <div className='h-100'>
    {data.length > 0 && data?.map((value, keyName) => (
      ...
      data.length === 0 && <div className='d-flex flex-column justify-content-between h-100'>
        ...
        <div>
          <div className="show-experts-menu-wrapper d-flex flex-column flex-md-row align-item-center justify-content-between bg-db p-3 pb-0">
            <div className="left-section mb-3">
              ...
              <p className="desc o-05 mb-0">Lets connect and get your work done!</p>
            </div>
            <div className='mb-3'>
              <ExpertButton />
            </div>
