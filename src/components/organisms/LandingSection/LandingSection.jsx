          ...
          <div className="row">
            <div className="l-cont col-md-6 d-flex flex-column justify-content-center">
              <h1 className="mb-3 title">
                ...
                <br />
                <span className="text-green">Entrepreneurs.</span>
              </h1>
